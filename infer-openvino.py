...
#from optimum.intel import ORTStableDiffusionPipeline
import torch
import os

#os.environ["OMP_NUM_THREADS"] = "10"  # Set the number of threads to 4
...
def main(args):
    ...
    ov_config = {"INFERENCE_NUM_THREADS": args.num_cores}
    distilled = OVStableDiffusionPipeline.from_pretrained(
        ...
        "models/openvino-sd-v1-4", use_safetensors=True,
        #ov_config=ov_config
    )
